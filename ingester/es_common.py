    ...
    def __init__(self, elastic_conf):
        ...
        try:
            if elastic_conf.ssl_config is not None:
                ...
                self.es = elasticsearch.Elasticsearch(hosts=elastic_conf.hosts, timeout=999999, retry_on_timeout=True)
...
class ElasticIndexer:
    ...
    def get_unique_field_values_slice(self, args):
        ...
        s = s.source(includes=[field_name])  # only get ids, otherwise `fields` takes a list of field names
